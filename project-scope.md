...
- **Closed** — no further action needed; ticket is archived
...
- **Admin** — created at deployment; can create and manage agents
- **Agent** — created by admin; handles day-to-day ticket management
